...
path = os.path.join ('..',
                     'data',
                     'Texans_fantasy_point_labels.csv' )
...
texans_pd.to_csv('../data/texans_labled.tsv', sep='\t')
...
tweet_pd.to_csv('../data/tweets_labeled.tsv', sep='\t')
...
tweet_points_pd.to_csv('../data/tweets_points.tsv', sep='\t')
...
nfl_ts_data.to_csv('../data/nfl_sent_labeled.csv')

nfl_ts_points_pd = pd.DataFrame(nfl_ts_points_list)
nfl_ts_points_pd.to_csv('../data/nfl_sent_points_labeled.csv')